...
def main_screen():
    ...
    Label(text="Enter the secret key for Encrypted and Decrypted Text",fg="black",font=("calibri",13)).place(x=10,y=170)
    ...
    Button(text="RESET",height="2",width=65,bg="#1089ff",fg="white", bd=0,command=reset).place(x=10,y=300)
